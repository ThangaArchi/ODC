...
function showSelected(){
 ...
 function addFilesToPackage()
 {
 	...
 	var whtSpMult = new RegExp("\\s\\s+", "g"); //collapse multiple whitespaces in pkgname
 	document.WebDboxCreateDraftPkgForm.packageName.value=document.WebDboxCreateDraftPkgForm.packageName.value.replace(whtSpMult, " "); 
