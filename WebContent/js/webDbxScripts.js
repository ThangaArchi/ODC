...
addEvent(window, "load", highlightInboxPkg);
...
function highlightInboxPkg()
{
    
     var str=normalizeString(document.WebDboxInboxForm.inboxPkgToLit.value);
...
function movePkgsToTrash()
{
 ...
 if (table == null )
 {
  ...
  for (i=0;i<cbxhan.length;i++)
      ...
      document.WebDboxInboxForm.packToTrash.value=filesIndices;
      document.WebDboxInboxForm.packTrashOper.value='true'
      document.WebDboxInboxForm.action='WebDboxInboxMovePkgToTrash.do';
      document.WebDboxInboxForm.submit();      
