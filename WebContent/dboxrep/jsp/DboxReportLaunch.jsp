...
<jsp:param name="title" value="IBM Customer Connect DropBox - Launch Report"/>
<jsp:param name="h1" value="Launch Report"/>
<jsp:param name="subtitle" value="Modify date manage scheme and launch report"/>
</jsp:include>
...
<%
 ...
 /*--------------------------------------------------------------------------*\
     ...
     Name of the Application        :  DboxReportLaunch.jsp
...
%>
<html:errors/>
<odc:form method="POST" action="/LaunchReport" anchor="headers">
   ...
   <br />
   Adjust the date management scheme (below) as desired, and click on Submit
   to launch the report called <i><c:out value="${SavedReportForm.reportName}"/></i>.
