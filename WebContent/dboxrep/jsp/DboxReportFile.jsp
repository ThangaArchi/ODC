...
<jsp:param name="title" value="IBM Customer Connect DropBox - File Report"/>
<jsp:param name="h1" value="File reports"/>
<jsp:param name="subtitle" value="Report for Dropbox Files"/>
</jsp:include>
...
<%!
 ...
 /*--------------------------------------------------------------------------*\
     ...
     Name of the Application        :  DboxReportFile.jsp
     ...
     Overview of Application        :
        ...
        This JSP is used to show Dropbox Reporting File page
        
 \*--------------------------------------------------------------------------*/
%>

<%
   String cellheight = "28";
%>

<html:errors/>

<odc:form method="post" action="/FileReport" anchor="headers">
<html:hidden property="sortField"/>
<html:hidden property="sortDirection"/>
<br /><br />
<jsp:include page="support/submit_cancel.jsp" flush="true">
<jsp:param name="resetAction" value="File"/>
</jsp:include>
...
active during the specified interval will be included.  For a File Report, an
active record equates to file which existed in a package during
the interval.
...
<td><html:checkbox property="fileState" styleId="col2" onclick="updateSelect('selectAll','col',5);"/><strong>File State</strong></td>
<td><html:checkbox property="fileSize" styleId="col3" onclick="updateSelect('selectAll','col',5);"/><strong>File Size</strong></td>
<td><html:checkbox property="numComponents" styleId="col4" onclick="updateSelect('selectAll','col',5);"/><strong>Num Components</strong></td>
</tr>
</table>
...
<tr valign="top">
<td nowrap><html:checkbox property="fileStateFilter"/><strong>File State</strong></td>
<td colspan="2"><html:radio property="fileStateFilterModifier" value="NotStarted"/><strong>Not Started</strong>
<html:radio property="fileStateFilterModifier" value="Failed"/><strong>Failed</strong><br />
<html:radio property="fileStateFilterModifier" value="Completed"/><strong>Completed</strong>
</td>
</tr>
<tr>
...
<table cellspacing="0" cellpadding="0" border="0" width="600">
<tr>
<td nowrap><html:checkbox property="numFiles"/>Number of Files</td>
<td nowrap><html:checkbox property="avgNumComponents"/>Avg Number of Components</td>
<td nowrap><html:checkbox property="avgFileSize"/>Avg File Size</td>
</tr>
</table>
...
<table cellspacing="0" cellpadding="0" border="0" width="600">
<tr>
<td nowrap><html:checkbox property="fileName"/>File Name</td>
<td nowrap><html:checkbox property="createTime"/>Creation Time</td>
<td nowrap><html:checkbox property="deleteTime"/>Deletion Time</td>
</tr>
...
<bean:define id="cursortfield" name="FileForm" property="sortField"/>
<bean:define id="cursortdir"   name="FileForm" property="sortDirection"/>
...
<jsp:param name="modifier" value="File"/>
</jsp:include>
...
<td><html:link action="/FileSort" anchor="headers" name="sortparms"><html:img page="<%=\"/images/\"+img%>" border="0"/></html:link></td>
<td><html:link action="/FileSort" anchor="headers" name="sortparms" style="color:#000000"><%=header%></html:link></td>
</tr></table></th><%           
        }
        out.println("</tr>");
        ...
        while(results.hasMoreElements()) {
          ...
          /* If a dive down link is needed, do it. Note, this should be an image */
           ...
           if (fileid != null) {
              ...
              packinfoparms.put("fileInfo","fileInfo");
...
<%
           ...
           while(enum.hasMoreElements()) {
              ...
              if (FileForm.fieldHasSimpleFilter(fn)) {
                 fieldparms.put("modifyFieldName",fn);
                 fieldparms.put("modifyFieldValue",fv);
%>           
                 <td style="padding-top:4px;padding-bottom:4px">
                    <html:link anchor="headers" action="/FileModifyField" name="fieldparms">
                       <%=fv%>
                    </html:link>
                 </td>
<%           
