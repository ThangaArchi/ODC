...
<jsp:param name="title" value="IBM Customer Connect DropBox - Update Report"/>
<jsp:param name="h1" value="Update Report"/>
<jsp:param name="subtitle" value="Allows updating of a Dropbox report configuration"/>
</jsp:include>
...
<%
 ...
 /*--------------------------------------------------------------------------*\
     ...
     Name of the Application        :  DboxReportUpdate.jsp
...
%>
<html:errors/>
<html:form method="POST" action="/UpdateReport">
