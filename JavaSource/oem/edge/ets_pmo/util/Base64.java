...
/* ********  D E C O D I N G   M E T H O D S  ******** */
    ...
    public static void main(String[] args) 
    {
        ...
        FileOutputStream out_bytes;
        byte[] buffer = new byte[3];
		try {
			// defaults (OutputStream encodes, InputStream decodes)
			// same as new Base64.InputStream(fis, Base64.DECODE );
			in = new Base64.InputStream(new FileInputStream(args[0]));
			out_bytes = new FileOutputStream(args[1]);
