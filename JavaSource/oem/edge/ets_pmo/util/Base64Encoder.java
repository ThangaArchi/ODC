 ...
 */
   public String encode(String password) {
     ...
     //cat.info("Entering Base64Encoder.encode()");
      ...
      //Base64.encodeBytes(passwordInBytes);
      encodedPassword = Base64.encodeBytes(passwordInBytes);
  ...
  // JMC 4/18/02 - Needed this
   public static void main(java.lang.String[] args) {
      ...
      String orig = "Anyone have a base64 DECODE routine and how to decode an image from a base64 encoded stream to a TGraphicField or TBlobField in a table?";
      System.out.println("<============== Base64 Utility Encoder ================>\n");
         String encoded = be.encode(orig);
