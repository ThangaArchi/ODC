...
**
*/
public class DropboxAccessWebSvc2SoapBindingImpl implements oem.edge.ed.odc.dropbox.service.DropboxAccessWithHandler, ServiceLifecycle {
  ...
  // deregister/postcall
   ...
   public DropboxAccessWebSvc2SoapBindingImpl() {
    ...
    public oem.edge.ed.odc.dropbox.common.FileSlot 
       uploadFileSlotToPackageWithHandler(long arg1,
                                          long arg2,
                                          long arg3,
                                          boolean arg4,
                                          javax.activation.DataHandler arg5) 
       throws java.rmi.RemoteException, oem.edge.ed.odc.dsmp.common.DboxException {
       
      try {
         doreg();
         return dropbox.uploadFileSlotToPackageWithHandler(arg1, arg2, arg3, 
                                                           arg4, arg5);
    ...
    public javax.activation.DataHandler 
       downloadPackageWithHandler(long arg1, 
                                  java.lang.String arg2) 
       throws java.rmi.RemoteException, oem.edge.ed.odc.dsmp.common.DboxException {
      try {
         doreg();
         return dropbox.downloadPackageWithHandler(arg1, arg2);
      } finally {
         dodereg();
      }
    }

    public javax.activation.DataHandler downloadPackageItemWithHandler(long arg1,
                                                                       long arg2)
       throws java.rmi.RemoteException, oem.edge.ed.odc.dsmp.common.DboxException {
      try {
         doreg();
         return dropbox.downloadPackageItemWithHandler(arg1, arg2);
      } finally {
         dodereg();
      }
    }
    ...
    public javax.activation.DataHandler downloadPackageItemWithHandler(long arg1, 
      ...
      try {
         doreg();
         return dropbox.downloadPackageItemWithHandler(arg1, arg2, arg3, arg4);
      } finally {
         dodereg();
      }
    }
