...
public class FileStatusEvent extends DSMPEvent {
	...
	/**
	 * A String which identifies the source directory of a file. Not always valid, see various
 ...
 * @see #FileStatusTableModel.addFileStatusListener()
 */
public FileStatusEvent(FileInfo fi, long pID, String src, String error, boolean isBegun, Boolean upload) {
