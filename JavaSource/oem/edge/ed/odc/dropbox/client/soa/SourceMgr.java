 ...
 * @param fileID long
 */
public String getSourceDir(long fileID) {
	String source = null;
 ...
 * @param fileID long
 */
public void removeSourceDir(long fileID) {
	File s = new File(SRCDIR + File.separator + fileID + FILEXT);
	if (s.exists()) {
		s.delete();
	}
 ...
 * @param fileID long
 */
public void setSourceDir(String dir, long fileID) {
	File s = new File(SRCDIR);
	if (! s.exists() && ! s.mkdir()) {
