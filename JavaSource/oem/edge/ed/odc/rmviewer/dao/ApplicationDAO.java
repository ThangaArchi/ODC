...
public class ApplicationDAO implements IApplicationDAO {
	...
	/* (non-Javadoc)
	 * @see oem.edge.ed.odc.rmviewer.dao.IApplicationDAO#insert(oem.edge.ed.odc.utils.ValueObject)
	 */
...
//strSQL = "INSERT INTO ODC.APPLICATION_REMOTEVIEWER VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	/* (non-Javadoc)
	 * @see oem.edge.ed.odc.rmviewer.dao.IApplicationDAO#deleteApplication(oem.edge.ed.odc.utils.ValueObject)
	 */
...
//strSQL = "DELETE FROM ODC.USER_APPL_REMOTEVIEWER WHERE APPL_ID=?";
	...
	/* (non-Javadoc)
	 * @see oem.edge.ed.odc.rmviewer.dao.IApplicationDAO#editApplication(oem.edge.ed.odc.utils.ValueObject)
	 */
...
//strSQL = "UPDATE ODC.APPLICATION_REMOTEVIEWER SET APPL_NAME=?, SERVER_NAME=?, APPL_PATH=?, ID_PREFIX=?, NUMBEROF_USERS=?, FILESYSTEM_TYPE=? WHERE APPL_ID=?";
	...
	/* (non-Javadoc)
	 * @see oem.edge.ed.odc.rmviewer.dao.IApplicationDAO#findAllApplications()
	 */
...
//strSQL = sqlCode.getSQLStatement("ODC.DAO.ApplicationDAO.allApplication");
	...
	/* (non-Javadoc)
	 * @see oem.edge.ed.odc.rmviewer.dao.IApplicationDAO#findSingleUserApplication(oem.edge.ed.odc.rmviewer.actions.ApplicationForm)
	 */
