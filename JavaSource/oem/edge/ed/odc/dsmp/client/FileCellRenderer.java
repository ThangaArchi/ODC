...
public class FileCellRenderer extends JLabel implements TableCellRenderer {
	static public ImageIcon FILE = new ImageIcon(FileCellRenderer.class.getResource("/oem/edge/ed/odc/dsmp/client/document.gif"));
	static public ImageIcon DIRECTORY = new ImageIcon(FileCellRenderer.class.getResource("/oem/edge/ed/odc/dsmp/client/folder.gif"));
