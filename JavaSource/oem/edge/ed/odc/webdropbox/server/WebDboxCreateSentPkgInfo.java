...
/**
 * The Bean WebDboxCreateSentPkgInfo.java is populated with important data which is used
 * for rendering the CreateSentpackage.jsp
 * Webpage Information pertaining to the Package name,acls,expiration,files 
 * etc. is stored in this bean
 */
public class WebDboxCreateSentPkgInfo {
...
//		 JGSDC Storage Pools
		...
		public WebDboxCreateSentPkgInfo(){}

		
		public Vector getRecipientsList() {
		
			return recipientsList;
		}

		
		public void setRecipientsList(Vector vector) {
			recipientsList = vector;
		}

		
		public Enumeration getRcptEnum() {
			return rcptEnum;
		}

		
		public void setRcptEnum(Enumeration enumeration) {
			rcptEnum = enumeration;
		}

		
		public Vector getSendList() {
			return sendList;
		}

		
		public void setSendList(Vector vector) {
			sendList = vector;
		}

		
		public Enumeration getSendEnum() {
			return sendEnum;
		}

		
		public void setSendEnum(Enumeration enumeration) {
			sendEnum = enumeration;
		}

		
		public boolean isDisablePkgNameField() {
			return disablePkgNameField;
		}

		
		public void setDisablePkgNameField(boolean b) {
			disablePkgNameField = b;
		}

		
		public boolean isEditPackageRcpt() {
			return editPackageRcpt;
		}

		
		public void setEditPackageRcpt(boolean b) {
			editPackageRcpt = b;
		}
		...
		public String getSelectedExpireValue() {
			return selectedExpireValue;
		}

		
		public void setSelectedExpireValue(String string) {
			selectedExpireValue = string;
		}

		
		public Vector getExpirationValues() {
			return expirationValues;
		}

		
		public void setExpirationValues(Vector vector) {
			expirationValues = vector;
		}
                	/**
		 * @param b
		 */
