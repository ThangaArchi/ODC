...
*/
   ...
   public DOMWriter(String encoding, boolean canonical,String Filename )              
   throws UnsupportedEncodingException {
	   try{
      out = new PrintWriter(new OutputStreamWriter(new java.io.FileOutputStream(Filename), encoding));
...
public DOMWriter(boolean canonical) throws UnsupportedEncodingException {     
   ...
   /** Default constructor. */
   public DOMWriter(boolean canonical,String Filename) throws UnsupportedEncodingException {
      this( getWriterEncoding(), canonical,Filename);
   }
