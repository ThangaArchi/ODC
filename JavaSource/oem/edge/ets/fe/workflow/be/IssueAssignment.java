...
public class IssueAssignment {
	private static final Log logger = 
		EtsLogger.getLogger(IssueAssignment.class);
...
public void process() {
    ...
    try
	{
    	Global.Init();
   		...
   		DBHandler.fireUpdate(db.conn, "insert into ets.ets_admin_log values(current timestamp, 'SYSTEMID', 'AICWF', 'CRONJOB', 'IssueAssignJob','Started','')");
    	...
    	DBHandler.fireUpdate(db.conn, "insert into ets.ets_admin_log values(current timestamp, 'SYSTEMID', 'AICWF', 'CRONJOB', 'IssueAssignJob','Ended','')");
	...
	public static void main(String[] args) {
		...
		IssueAssignment ia = new IssueAssignment();
		ia.process();
	}
}
