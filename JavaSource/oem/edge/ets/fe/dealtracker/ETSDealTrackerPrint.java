...
public class ETSDealTrackerPrint {
	...
	static public StringBuffer doDashboardView(ETSDealTrackerResultObj resobj,String userRole,boolean user_external,boolean printview,ETSParams params,Vector notEditor){
		...
		try{
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_TASKID_STR)){ 
			   if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
				   ...
				   if (!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_TASKID_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
					   buf.append("Task</a>");
				   }
				   else{
						buf.append("Task");
				   ...
				   buf.append("<img src=\"" + Defines.ICON_ROOT + "u.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"ascending\" /></td>");
				   buf.append("</table></th>");
			   }
			   else{
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if (!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_TASKID_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
					   buf.append("Task</a>");
				   }
				   else{
						buf.append("Task");
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_TITLE_STR)){ 
			   if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if (!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_TITLE_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
					   buf.append("Title</a>");
				   }
				   else{
						buf.append("Title");
				   ...
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if(!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_TITLE_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
					   buf.append("Title</a>");
				   }
				   else{
						buf.append("Title");
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_SECT_STR)){ 
			   if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if(!printview){
//					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_SECT_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
...
//						buf.append("Section");
				   ...
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if(!printview){
//					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_SECT_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
//					   buf.append("Section</a>");
				   }
				   else{
//						buf.append("Section");
...
//					buf.append("Section</th>");	
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_OWNER_STR)){ 
			   if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if (!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_OWNER_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
					   buf.append("Owner</a>");
				   }
				   else{
						buf.append("Owner");
				   ...
				   buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
				   if (!printview){
					   buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_OWNER_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
					   buf.append("Owner</a>");
				   }
				   else{
						buf.append("Owner");
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_DATE_STR)){ 
				if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
					buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
					if (!printview){
						buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_DATE_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
						buf.append("Date</a>");
					}
					else{
						buf.append("Date");	
					...
					buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
					if (!printview){
						buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_DATE_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
						buf.append("Date</a>");
					}
					else{
						buf.append("Date");	
			...
			if (resobj.getSortBy().equals(Defines.SORT_BY_DT_STATUS_STR)){ 
				if (resobj.getAD().equals(Defines.SORT_ASC_STR)){
					buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
					if (!printview){
						buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_STATUS_STR+"&sort="+Defines.SORT_DES_STR+"\" class=\"fbox\">");
						buf.append("Status</a>");
					}
					else{
						buf.append("Status");
					...
					buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr><td headers=\"\" align=\"left\" valign=\"middle\" height=\"16\">");
					if (!printview){
						buf.append("<a class=\"parent\" href=\"ETSProjectsServlet.wss?proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"&sort_by="+Defines.SORT_BY_DT_STATUS_STR+"&sort="+Defines.SORT_ASC_STR+"\">");
						buf.append("Status</a>");
					}
					else{
						buf.append("Status");	
			...
			if (tasks.size()>0){
				...
				for (int t=0; t<tasks.size();t++){
					...
					if (!(task.isIbmOnly() && user_external)){
						...
						if (!printview)
							buf.append("<a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+"&linkid="+params.getLinkId()+"\" class=\"fbox\">"+task.getTitle()+"</a>");
						else
...
//						buf.append("<td headers=\"\" width=\""+w4+"\" >"+task.getSection()+"</td>");
			...
			buf.append(printDashboardButtons(resobj,printview,hasTaskShown,user_external,userRole,params,notEditor,owner_submitter));
	...
	static public StringBuffer printDashboardButtons(ETSDealTrackerResultObj resobj,boolean printview,boolean hasTaskShown,boolean user_external,String userRole, ETSParams params,Vector notEditor,boolean owner_submitter){
		StringBuffer buf = new StringBuffer();
		
		String etsop = "";
		if (resobj.isSetMet)
			etsop = "&etsop=action&set="+resobj.getSelfId();
		
		if(!printview){
			buf.append("<tr><td headers=\"\" colspan=\"8\"><img src=\"//www.ibm.com/i/c.gif\" height=\"20\" width=\"1\" alt=\"\" /></td></tr>\n");
			buf.append("<tr><td headers=\"\" colspan=\"8\"><img src=\"" + Defines.V11_IMAGE_ROOT + "gray_dotted_line.gif\" height=\"1\" width=\"600\" alt=\"\" /></td></tr>\n");
			buf.append("<tr><td headers=\"\" colspan=\"8\"><img src=\"//www.ibm.com/i/c.gif\" height=\"20\" width=\"1\" alt=\"\" /></td></tr>\n");
				
			buf.append("<tr><td headers=\"\" colspan=\"8\">");
			buf.append("<table  cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr>\n");
					
			if (!notEditor.contains(userRole)){
				buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><a href=\"ETSProjectsServlet.wss?action=addtask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\"><img src=\"" + Defines.ICON_ROOT + "fw.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"add new task\" /></a></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><a href=\"ETSProjectsServlet.wss?action=addtask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\">Add task</a></td>");
				if (!user_external){
					buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
					buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><a href=\"ETSProjectsServlet.wss?action=additask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\"><img src=\"" + Defines.ICON_ROOT + "fw.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"add IBM only task\" /></a></td>");
					buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><a href=\"ETSProjectsServlet.wss?action=additask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\">Add IBM only task</a></td>");				
				}
					
				if (hasTaskShown && (owner_submitter || params.isSuperAdmin() || userRole.equals(Defines.WORKSPACE_OWNER))){
					buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
					buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><a href=\"ETSProjectsServlet.wss?action=editdash&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\"><img src=\"" + Defines.ICON_ROOT + "fw.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"edit this view\" /></a></td>");
					buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><a href=\"ETSProjectsServlet.wss?action=editdash&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\">Edit this view</a></td>");
				}
				buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
			}	
			...
			buf.append("<td headers=\"\" valign=\"top\" algin=\"right\">" +
				"<a href=\"ETSProjectsServlet.wss?action=print&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"&skip=Y&sort_by="+resobj.getSortBy()+"&sort="+resobj.getAD()+"\" class=\"fbox\" target=\"new\" " +
					"onclick=\"window.open('ETSProjectsServlet.wss?action=print&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"&skip=Y&sort_by="+resobj.getSortBy()+"&sort="+resobj.getAD()+"','New','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=1,resizable=1,width=650,height=500,top=200');return false;\" " +
			...
			buf.append("<td headers=\"\" valign=\"top\" algin=\"left\">&nbsp;<a href=\"ETSProjectsServlet.wss?action=print&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"&skip=Y&sort_by="+resobj.getSortBy()+"&sort="+resobj.getAD()+"\" class=\"fbox\" target=\"new\" " +
				"onclick=\"window.open('ETSProjectsServlet.wss?action=print&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"&skip=Y&sort_by="+resobj.getSortBy()+"&sort="+resobj.getAD()+"','New','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=1,resizable=1,width=650,height=500,top=200');return false;\" " +
				"onkeypress=\"window.open('ETSProjectsServlet.wss?action=print&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"&skip=Y&sort_by="+resobj.getSortBy()+"&sort="+resobj.getAD()+"','New','toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=1,resizable=1,width=650,height=500,top=200');return false;\">Printable version</a></td>");
					
			// Added in 6.3 RELEASE - SRIKANTH
			if (!Defines.WORKSPACE_VISITOR.equals(userRole)) {
				buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><a href=\"ETSProjectsServlet.wss?action=importtask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\"><img src=\"" + Defines.ICON_ROOT + "fw.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"Import task list\" /></a></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><a href=\"ETSProjectsServlet.wss?action=importtask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\">Import task list</a></td>");				
				buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><a href=\"ETSProjectsServlet.wss?action=exporttask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\"><img src=\"" + Defines.ICON_ROOT + "fw.gif\" border=\"0\"  height=\"16\" width=\"16\" alt=\"Export task list\" /></a></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><a href=\"ETSProjectsServlet.wss?action=exporttask&proj="+params.getETSProj().getProjectId()+"&tc="+params.getTopCat()+"&cc="+params.getTopCat()+etsop+"&linkid="+params.getLinkId()+"\" class=\"fbox\">Export task list</a></td>");				
			}
			else {
				buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");				
				buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"right\"><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
				buf.append("<td headers=\"\" valign=\"top\" algin=\"left\"><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");				
			}
	...
	static public StringBuffer doAddTask(ETSParams params,int CurrentCatId, Hashtable h, boolean ibmonly,String msg){
		StringBuffer buf = new StringBuffer();
		...
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"2\"><b>Task:</b></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\">New</td>");
		// v2srikau: remove section from contracts Add Task. 
//		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><label for=\"section\"><b>Section:</b></label>&nbsp;&nbsp;</td>");
//		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><input id=\"section\" type=\"text\" name=\"section\" size=\"25\"  style=\"width:150px\" width=\"150px\" maxlength=\"10\" value=\""+ETSDealTrackerCommonFuncs.getHashStrValue(h,"section")+"\" class=\"iform\" /></td>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\">&nbsp;</td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><input id=\"section\" type=\"hidden\" name=\"section\" value=\""+ETSDealTrackerCommonFuncs.getHashStrValue(h,"section")+"\" class=\"iform\" /></td>");
		buf.append("</tr>\n");
		
		buf.append("<tr><td headers=\"\" colspan=\"5\"><img src=\"//www.ibm.com/i/c.gif\" height=\""+rspacer+"\" width=\"1\" alt=\"\" /></td></tr>\n");
		
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><span class=\"ast\"><b>*</b></span></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><label for=\"title\"><b>Title:</b></label></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"3\"><input id=\"section\" type=\"text\" name=\"title\" size=\"42\" style=\"width:300px\" width=\"300px\" maxlength=\"100\" value=\""+ETSDealTrackerCommonFuncs.getHashStrValue(h,"title")+"\" class=\"iform\" /></td>");
		buf.append("</tr>\n");
		...
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"3\">\n");
		...
		try{
			...
			if (ibmonly){
				users = ETSDealTrackerCommonFuncs.getIBMMembers(users,conn);
			}
		...
		if(!Project.getCompany().equals("IBM") && !ibmonly){
		...
		buf.append("<tr><td headers=\"\" colspan=\"5\"><img src=\"//www.ibm.com/i/c.gif\" height=\"15\" width=\"1\" alt=\"\" /></td></tr>\n");
		
//		buf.append("<tr>");
//		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"2\"><label for=\"wreq\"><b>Work required:</b></label></td>");
//		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"3\">");
		String swreq = ETSDealTrackerCommonFuncs.getHashStrValue(h,"wreq");
//		buf.append("<textarea rows=\"5\" cols=\"30\" id=\"wreq\" name=\"wreq\" style=\"width:300px\" width=\"300px\" class=\"iform\">"+swreq+"</textarea>\n");
//		buf.append("</td>");
//		buf.append("</tr>\n");
		buf.append("<input type=\"hidden\" id=\"wreq\" name=\"wreq\" value=\""+swreq+"\">\n");
		...
		buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "cancel_rd.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<b><a class=\"fbox\" href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Cancel</a></b></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
...
//			buf.append("<tr height=\"21\"><td headers=\"\" align=\"left\" width=\"90\"><b>Section:</b></td><td headers=\"\" align=\"left\">"+task.getSection()+"</td></tr>");
			buf.append("<tr height=\"21\"><td headers=\"\" align=\"left\" width=\"90\">&nbsp;</td></tr>");
			...
			buf.append("<tr><td headers=\"\" colspan=\"4\"><img src=\"//www.ibm.com/i/c.gif\" height=\"10\" width=\"1\" alt=\"\" /></td></tr>\n");
			buf.append("<tr>");
			buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
			buf.append("<img src=\"" + Defines.ICON_ROOT + "fw_c.gif\"  border=\"0\"  height=\"16\" width=\"16\" alt=\"Edit Task\" /></a></td>");
			buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Work with this task</a></td>");

			buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
			buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
			buf.append("<img src=\"" + Defines.ICON_ROOT + "bk.gif\"  border=\"0\"  height=\"16\" width=\"16\" alt=\"Back to main\" /></a></td>");
			buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Back to "+o.getBackStr()+"</a></td>");
			buf.append("</tr>\n");
			buf.append("</table>\n");
			//writer.println(buf.toString());
			return buf.toString();
	...
	static public String printTaskDetails(ETSParams params,int CurrentCatId, EdgeAccessCntrl es, String userRole, ETSDealTrackerResultObj o, boolean user_external){
	//get task
	...
	//print the details
		...
		try{
			ETSTask task = (ETSTask)o.getTask();
			
			if (params.isSuperAdmin() || task.getOwnerId().equals(es.gIR_USERN) || task.getCreatorId().equals(es.gIR_USERN) || userRole.equals(Defines.WORKSPACE_OWNER) || userRole.equals(Defines.WORKSPACE_MANAGER))
				canEdit = true;
...
//			buf.append("<td headers=\"\" align=\"left\" width=\""+w3+"\"><b>Section:</b></td><td headers=\"\" align=\"left\" width=\""+w4+"\">"+task.getSection()+"</td></tr>");
			buf.append("<td headers=\"\" align=\"left\" width=\""+w3+"\">&nbsp;</td><td headers=\"\" align=\"left\" width=\""+w4+"\">&nbsp;</td></tr>");
...
//			buf.append("<tr><td headers=\"\" align=\"left\" width=\""+w1+"\" valign=\"top\"><b>Work required:</b></td><td headers=\"\" colspan=\"3\" align=\"left\">"+task.getWorkRequired()+"</td></tr>");
			buf.append("<tr><td headers=\"\" align=\"left\" width=\""+w1+"\" valign=\"top\">&nbsp;</td><td headers=\"\" colspan=\"3\" align=\"left\">&nbsp;</td></tr>");
			buf.append("<tr><td headers=\"\" colspan=\"4\"><img src=\"//www.ibm.com/i/c.gif\" height=\"10\" width=\"1\" alt=\"\" /></td></tr>\n");
			...
			if (canEdit){
				...
				buf.append("<td headers=\"\" align=\"left\"><a href=\"ETSProjectsServlet.wss?action=edetails&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Edit task details</a></td>");
				...
				buf.append("<td headers=\"\" align=\"left\"><a href=\"ETSProjectsServlet.wss?action=deltask&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Delete this task</a></td></tr>");
			...
			if (docs.size() > 0){
				...
				for (int i = 0; i < docs.size(); i++){
					...
					if(canEdit)
						buf.append("<td headers=\"\" align=\"left\" valign=\"top\" class=\"small\"><a href=\"ETSProjectsServlet.wss?action=deltaskdoc&docid="+doc.getId()+"&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\">Delete</a></td>");
					else
			...
			if (canEdit){
				...
				buf.append("<td headers=\"\" align=\"left\"><a href=\"ETSProjectsServlet.wss?action=addtaskdoc&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Add document</a></td</tr>");
				buf.append("</table>");
			}
			...
			if (canEdit){	
				...
				buf.append("<tr><td headers=\"\" colspan=\"2\"><img src=\"//www.ibm.com/i/c.gif\" height=\"10\" width=\"1\" alt=\"\" /></td></tr>\n");
				buf.append("<tr><td headers=\"\" width=\"16\" align=\"right\"><img src=\""+Defines.ICON_ROOT+"fw.gif\" height=\"16\" width=\"16\" alt=\"\" border=\"0\"/></td>");
				buf.append("<td headers=\"\" align=\"left\"><a href=\"ETSProjectsServlet.wss?action=addtaskcomm&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Add comment</a></td</tr>");
				buf.append("</table>");
			}
			...
			if (dTasks.size() > 0){
				...
				for (int i = 0; i < dTasks.size(); i++){
					ETSTask dTask = (ETSTask)dTasks.elementAt(i);
					...
					if (canEdit){
						buf.append("<td headers=\"\" width=\""+dw8+"\" align=\"left\" valign=\"top\" class=\"small\"><a href=\"ETSProjectsServlet.wss?action=deldtask&dtaskid="+dTask.getId()+"&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\">Remove</a></td>");
					}
			...
			if (canEdit){	
				...
				buf.append("<tr><td headers=\"\" colspan=\"2\"><img src=\"//www.ibm.com/i/c.gif\" height=\"10\" width=\"1\" alt=\"\" /></td></tr>\n");
				buf.append("<tr><td headers=\"\" width=\"16\" align=\"right\"><img src=\""+Defines.ICON_ROOT+"fw.gif\" height=\"16\" width=\"16\" alt=\"\" border=\"0\"/></td>");
				buf.append("<td headers=\"\" align=\"left\"><a href=\"ETSProjectsServlet.wss?action=adddtask&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Add dependent task</a></td</tr>");
				buf.append("</table>");
			}
			if (hasDIbmOnly){	
				buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\">\n");				
	...
	static public String doDelTaskDoc(ETSParams params, int CurrentCatId, ETSDealTrackerResultObj o,int docid,int taskid){
		...
		try{
			...
			buf.append("<br />");	
			buf.append("<form action=\"ETSProjectsServlet.wss?taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\" method=\"post\" name=\"deldoc\">");
			...
			buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
			buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
			buf.append("<img src=\"" + Defines.BUTTON_ROOT + "cancel_rd.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
			buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<b><a class=\"fbox\" href=\"ETSProjectsServlet.wss?action=details&taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Cancel</a></b></td>");
			buf.append("</tr>\n");
			buf.append("</table>\n");
			buf.append("</form>");
			//writer.println(buf.toString());
	...
	static public String doDelTaskDoc2(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o,int docid,int taskid){
		...
		buf.append("<br />");	
		buf.append("<form action=\"ETSProjectsServlet.wss?action=details&taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\" method=\"post\" name=\"deldoc\">");
		...
		//buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		//buf.append("<img src=\"" + Defines.BUTTON_ROOT + "cancel_rd.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
		//buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?action=details&taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Cancel</a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("</form>");
		//writer.println(buf.toString());
	...
	static public String editTaskDetails(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o, Hashtable h,boolean ibmonly, String msg){
		ETSProj Project = params.getETSProj();
		int TopCatId = params.getTopCat();
		String linkid = params.getLinkId();
		Connection conn = params.getConnection();
		...
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"2\"><b>Task:</b></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\">"+ETSDealTrackerCommonFuncs.getHashStrValue(h,"taskid")+"</td>");
//		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><label for=\"section\"><b>Section:</b></label>&nbsp;&nbsp;</td>");
//		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><input id=\"section\" type=\"text\" name=\"section\" size=\"25\"  style=\"width:150px\" width=\"150px\" maxlength=\"10\" value=\""+ETSDealTrackerCommonFuncs.getHashStrValue(h,"section")+"\" class=\"iform\" /></td>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\">&nbsp;&nbsp;</td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\"><input id=\"section\" type=\"hidden\" name=\"section\" value=\""+ETSDealTrackerCommonFuncs.getHashStrValue(h,"section")+"\" /></td>");
		buf.append("</tr>\n");
...
//		buf.append("</td>");
//		buf.append("</tr>\n");
		buf.append("<input type=\"hidden\" name=\"wreq\" id =\"wreq\" value=\""+swreq+"\"/> \n");
	...
	static public String editTaskDetails2(ETSParams params, int CurrentCatId,ETSTask task,Hashtable h, boolean ibmonly,ETSDealTrackerResultObj o){
		ETSProj Project = params.getETSProj();
		int TopCatId = params.getTopCat();
		String linkid = params.getLinkId();
		Connection conn = params.getConnection();
...
//		buf.append("<tr height=\"21\"><td headers=\"\" align=\"left\" width=\"90\"><b>Section:</b></td><td headers=\"\" align=\"left\" width=\"510\">"+task.getSection()+"</td></tr>");
		buf.append("<tr height=\"21\"><td headers=\"\" align=\"left\" width=\"90\">&nbsp;</td></tr>");
		...
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\" colspan=\"2\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
	...
	static public String doAddTaskComment(ETSParams params, int CurrentCatId,String taskid, String comment,String msg){
		ETSProj Project = params.getETSProj();
		int TopCatId = params.getTopCat();
		String linkid = params.getLinkId();
		...
		buf.append("<form action=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\" name=\"addCommForm\" method=\"post\">");
		buf.append("<input type=\"hidden\" name=\"action\" value=\"addtaskcomm2\" />");
		buf.append("<input type=\"hidden\" name=\"taskid\" value=\""+taskid+"\" />");
	...
	static public String doAddTaskComment2(ETSParams params, int CurrentCatId, ETSDealTrackerResultObj o){
		...
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\" colspan=\"2\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+t.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "continue.gif\"  border=\"0\"  height=\"21\" width=\"120\" alt=\"Task details\" /></a></td>");
		//buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?action=edittask&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Work with this task</a></td>");
	...
	static public String doAddDepTask(ETSParams params, int CurrentCatId, ETSDealTrackerResultObj o,boolean user_external, String msg){
		...
		try{
			...
			for (int tcnt=0;tcnt<tasks.size();tcnt++){
				...
				ETSTask task=(ETSTask)tasks.elementAt(tcnt);
				buf.append("<tr>");
			...
			buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+t.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
			buf.append("<img src=\"" + Defines.BUTTON_ROOT + "cancel_rd.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
			buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<b><a class=\"fbox\" href=\"ETSProjectsServlet.wss?action=details&taskid="+t.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Cancel</a></b></td>");
			buf.append("</tr>\n");
			buf.append("</table>\n");
	...
	static public String doAddDepTask2(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o,String taskid, boolean user_external,String msg){
		...
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\" colspan=\"2\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+taskid+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "continue.gif\"  border=\"0\"  height=\"21\" width=\"120\" alt=\"Task details\" /></a></td>");
		
		buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.ICON_ROOT + "bk.gif\"  border=\"0\"  height=\"16\" width=\"16\" alt=\"Back to "+o.getBackStr()+"\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Back to "+o.getBackStr()+"</a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		//writer.println(buf.toString());
	...
	static public String doDelDepTask(ETSParams params, int CurrentCatId, ETSDealTrackerResultObj o,boolean user_external,String msg){
		...
		ETSTask task = o.getTask();
		ETSTask dTask = o.getDepTask();
					
		StringBuffer buf = new StringBuffer();

		buf.append("<br />");
		buf.append("<form action=\"ETSProjectsServlet.wss?taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&linkid="+linkid+"\" method=\"post\" name=\"deldoc\">");
		...
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "cancel_rd.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<b><a class=\"fbox\" href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Cancel</a></b></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("</form>");
		//writer.println(buf.toString());
	...
	static public String doDelDepTask2(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o){
		...
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?action=details&taskid="+task.getId()+"&proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Back to task details</a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("</form>");
		//writer.println(buf.toString());
	...
	static public String doDelTask2(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o){
		...
		buf.append("<tr height=\"21\"><td headers=\"\" align=\"left\" width=\"90\"><b>Section:</b></td><td headers=\"\" align=\"left\" width=\"510\">"+section+"</td></tr>");
		...
		buf.append("<tr>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.ICON_ROOT + "bk_c.gif\"  border=\"0\"  height=\"16\" width=\"16\" alt=\"Back to "+o.getBackStr()+"\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Back to "+o.getBackStr()+"</a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("</form>");
	...
	static public String doEditDash(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o,String msg,boolean sub){
		ETSProj Project = params.getETSProj();
		int TopCatId = params.getTopCat();
		String linkid = params.getLinkId();
...
//			buf.append("<td headers=\"\" class=\"small\" width=\""+w2+"\"><label for=\"section\"><b>Section</b></label></td></tr>");
			buf.append("<td headers=\"\" class=\"small\" width=\""+w2+"\">&nbsp;</td></tr>");
...
//			buf.append("<td headers=\"\" width=\""+w2+"\"><input id=\"section\" type=\"text\" name=\"section_"+task.getId()+"\" size=\"25\"  style=\"width:125px\" width=\"125px\" maxlength=\"10\" value=\""+(sub?ETSDealTrackerCommonFuncs.getParameter(request,"section_"+task.getId()):task.getSection())+"\" class=\"iform\" /></td></tr>");
			buf.append("<td headers=\"\" width=\""+w2+"\"><input id=\"section\" type=\"hidden\" name=\"section_"+task.getId()+"\" value=\""+(sub?ETSDealTrackerCommonFuncs.getParameter(request,"section_"+task.getId()):task.getSection())+"\" /></td></tr>");
			...
			buf.append("<td headers=\"\" class=\"small\"><label for=\"status\"><b>Status</b></label></td></tr>");
	...
	static public String doEditDash2(ETSParams params, int CurrentCatId,ETSDealTrackerResultObj o){
		...
		StringBuffer buf = new StringBuffer();	
			...
			buf.append("<br /><br />");	
			buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"600\" border=\"0\">\n");
			buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"2\">You have successfully updated the tasks.</td></tr>");
...
/*
	...
	static private String getHashStrValue(Hashtable h, String key)
		{
...
*/
	...
	static public StringBuffer doImportTask(ETSParams params,int CurrentCatId, Hashtable h, boolean ibmonly,Object msg){
		StringBuffer buf = new StringBuffer();
		...
		if (msg != null && !msg.equals("")) {
		    if (msg.equals("1")) {
		        msg = "Task list file is missing OR empty.";
		    }
		    else if (msg.equals("2")) {
		        msg ="The first line (file header) is incorrect, data cannot be uploaded at this time. Make sure the format is as per the template.";
		    }
			if(!msg.equals("")){
				buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"443\" border=\"0\">");
				buf.append("<tr><td><img src=\"//www.ibm.com/i/c.gif\" height=\"15\" width=\"1\" alt=\"\" /></td></tr>");
		...
		buf.append("<form action=\"uploadTasks.wss\" name=\"uploadTaskForm\"  enctype=\"multipart/form-data\" method=\"post\">\n");	
		buf.append("<input type=\"hidden\" name=\"proj\" value=\""+Project.getProjectId()+"\" />");
		buf.append("<input type=\"hidden\" name=\"tc\" value=\""+TopCatId+"\" />");
		buf.append("<input type=\"hidden\" name=\"cc\" value=\""+CurrentCatId+"\" />");
		buf.append("<input type=\"hidden\" name=\"linkid\" value=\""+linkid+"\" />");
		buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"443\" border=\"0\">\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"5\">&nbsp;</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"5\"><span class=\"ast\"><b>*</b></span>&nbsp;<label for=\"title\"><b>Task List</b></label>");
		buf.append("<a href=\"ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Import Tasks&proj="+Project.getProjectId()+"\""); 
		buf.append(" onclick=\"window.open('ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Import Tasks&proj="+Project.getProjectId()+"','Help','toolbar=0,location=0,resizable=1,scrollbars=1,status=0,menubar=0,left=200,top=100,width=350,height=450');return false\"");
		buf.append(" onkeypress=\"window.open('ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Import Tasks&proj="+Project.getProjectId()+"','Help','toolbar=0,location=0,resizable=1,scrollbars=1,status=0,menubar=0,left=200,top=100,width=350,height=450')\">");
		buf.append("<img border=\"0\" name=\"Help\" src=\"" + Defines.ICON_ROOT + "/popup.gif\" width=\"16\" height=\"16\" alt=\"Click for help on this field\" /></a>&nbsp;");

		buf.append("</td></tr>");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" align=\"left\" valign=\"top\" colspan=\"5\"><input id=\"taskList\" type=\"file\" name=\"taskList\" size=\"42\" style=\"width:300px\" width=\"300px\" maxlength=\"100\" class=\"iform\" /></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
	...
	static public StringBuffer doImportTask2(ETSParams params,int CurrentCatId, Hashtable h, boolean ibmonly,Object msg){
		StringBuffer buf = new StringBuffer();
        ...
        HttpSession pdSession = params.getRequest().getSession();
		String strSuccessCount = 
            (String) pdSession.getAttribute("_taskImportCount");
		
		String strUpdateCount = 
            (String) pdSession.getAttribute("_taskUpdateCount");
		
		String strUpdateList = 
            (String) pdSession.getAttribute("_taskUpdateList");

		pdSession.removeAttribute("_taskImportCount");
        pdSession.removeAttribute("_taskUpdateCount");
        pdSession.removeAttribute("_taskUpdateList");
        boolean bHasErrors = false;
		if (msg != null && !msg.equals("")) {
		    if (msg.equals("3")) {
		        List lstErrors = (List) pdSession.getAttribute("_taskImportErrors");
		        if (lstErrors != null && lstErrors.size() > 0) {
		            StringBuffer errorBuffer = new StringBuffer("");
		            errorBuffer.append("<span style=\"color:#ff3333\">Following data rows could not be parsed due to incorrect data elements.</span><br /><br />");
		            for(int i=0; i < lstErrors.size(); i++) {
		                TaskUploadObj taskError = (TaskUploadObj) lstErrors.get(i);
		                errorBuffer.append(taskError.getData());
		                if (taskError.getMsg() != null) {
		                    errorBuffer.append("<br />");
		                    errorBuffer.append("<span style=\"color:#ff3333\">("+ taskError.getMsg() +")</span>");
		                    errorBuffer.append("<br />");
		                }
		        ...
		        pdSession.removeAttribute("_taskImportErrors");
		    }
			if(!msg.equals("")){
				buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"443\" border=\"0\">");
				buf.append("<tr><td><img src=\"//www.ibm.com/i/c.gif\" height=\"15\" width=\"1\" alt=\"\" /></td></tr>");
				if (!strSuccessCount.equals("0")) {
					buf.append("<tr><td>"+ strSuccessCount +" task(s) added successfully.</td></tr>");
				}
				if (!strUpdateCount.equals("0")) {
					buf.append("<tr><td>"+ strUpdateCount +" task(s) updated successfully: " + strUpdateList + "</td></tr>");
				}
				buf.append("<tr><td>"+msg+"</td></tr>");
				buf.append("</table>\n");
			}
			bHasErrors = true;
		}
		...
		buf.append("<tr>");
		if (bHasErrors) {
			buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"&action=importtask\">");
			buf.append("<img src=\"" + Defines.BUTTON_ROOT + "/arrow_lt.gif\" border=\"0\"  height=\"21\" width=\"21\" alt=\"Cancel\" /></a></td>");
			buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a class=\"fbox\" href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"&action=importtask\"><b>Back</b></a></td>");
		}
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\">&nbsp;&nbsp;&nbsp;<a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "/arrow_lt.gif\" border=\"0\"  height=\"21\" width=\"21\" alt=\"OK\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a class=\"fbox\" href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\"><b>Done</b></a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		return buf;
		//writer.println(buf.toString());
	...
	static public StringBuffer doExportTask(ETSParams params,int CurrentCatId, Hashtable h, boolean ibmonly,String msg){
		StringBuffer buf = new StringBuffer();
		...
		buf.append("<script>");
		buf.append("function changeDisplayMode(flag) {");
		buf.append("    if (flag == 'true') { ");
		buf.append("		document.getElementById('taskstatus').style.display = 'inline';");
		buf.append("	}");
		buf.append("    else { ");
		buf.append("		document.getElementById('taskstatus').style.display = 'none';");
		buf.append("	}");
		buf.append("}");
		buf.append("</script>");
		buf.append("<form action=\"TaskExportServlet.wss\" name=\"exportTaskForm\" method=\"post\">\n");
		buf.append("<input type=\"hidden\" name=\"action\" value=\"exporttask2\" />");
		...
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"5\"><label for=\"heading\"><b>Select export criteria</b></label>");
//		buf.append("<a href=\"ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Export Tasks&proj="+Project.getProjectId()+"\""); 
//		buf.append(" onclick=\"window.open('ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Export Tasks&proj="+Project.getProjectId()+"','Help','toolbar=0,location=0,resizable=1,scrollbars=1,status=0,menubar=0,left=200,top=100,width=350,height=450');return false\"");
//		buf.append(" onkeypress=\"window.open('ETSContentManagerServlet.wss?OP=Contracts&BlurbField=Export Tasks&proj="+Project.getProjectId()+"','Help','toolbar=0,location=0,resizable=1,scrollbars=1,status=0,menubar=0,left=200,top=100,width=350,height=450')\">");
//		buf.append("<img border=\"0\" name=\"Help\" src=\"" + Defines.ICON_ROOT + "/popup.gif\" width=\"16\" height=\"16\" alt=\"Click for help on this field\" /></a>&nbsp;");
		buf.append("</td></tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"5\">&nbsp;</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" valign=\"top\" width=\"30%\" colspan=\"3\"><input type=\"radio\" name=\"selcriteria\" id=\"selcriteria\" value=\"T\" onclick=\"changeDisplayMode('false')\" /><u>Template only</u>:</td>");
		buf.append("<td headers=\"\" valign=\"top\" colspan=\"2\">To download a CSV template which can be used to add new tasks</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"5\">&nbsp;</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"3\"><input type=\"radio\" name=\"selcriteria\" id=\"selcriteria\" value=\"A\" onclick=\"changeDisplayMode('false')\" /><u>All tasks</u>:</td>");
		buf.append("<td headers=\"\" colspan=\"2\">To download the template along with all existing tasks in the workspace</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"5\">&nbsp;</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"3\"><input type=\"radio\" name=\"selcriteria\" id=\"selcriteria\" value=\"S\" onclick=\"changeDisplayMode('true')\" /><u>Tasks by status</u>:</td>");
		buf.append("<td headers=\"\" colspan=\"2\">To download the template along with tasks filtered by status</td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("<div id=\"taskstatus\" style=\"position:relative\">");
		buf.append("<table summary=\"\" cellpadding=\"0\" cellspacing=\"0\" width=\"443\" border=\"0\">\n");
		buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"5\">&nbsp;</td></tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"2\">&nbsp;</td>");
		buf.append("<td headers=\"\" colspan=\"3\"><input type=\"checkbox\" name=\"taskstatus\" id=\"taskstatus\" value=\"1\" />Complete</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"5\">&nbsp;</td></tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"2\">&nbsp;</td>");
		buf.append("<td headers=\"\" colspan=\"3\"><input type=\"checkbox\" name=\"taskstatus\" id=\"taskstatus\" value=\"2\" />In Progress</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"5\">&nbsp;</td></tr>\n");
		buf.append("<tr height=\"21\">");
		buf.append("<td headers=\"\" colspan=\"2\">&nbsp;</td>");
		buf.append("<td headers=\"\" colspan=\"3\"><input type=\"checkbox\" name=\"taskstatus\" id=\"taskstatus\" value=\"3\" />Not Started</td>");
		buf.append("</tr>\n");
		buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"5\">&nbsp;</td></tr>\n");
		buf.append("<tr height=\"21\"><td headers=\"\" colspan=\"5\">&nbsp;</td></tr>\n");
		buf.append("</table>\n");
		...
		buf.append("<td><img src=\"//www.ibm.com/i/c.gif\" height=\"1\" width=\"20\" alt=\"\" /></td>");
		buf.append("<td headers=\"\" align=\"right\" valign=\"top\"><a href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">");
		buf.append("<img src=\"" + Defines.BUTTON_ROOT + "arrow_lt.gif\"  border=\"0\"  height=\"21\" width=\"21\" alt=\"Back\" /></a></td>");
		buf.append("<td headers=\"\" align=\"left\" valign=\"middle\">&nbsp;<a class=\"fbox\" href=\"ETSProjectsServlet.wss?proj="+Project.getProjectId()+"&tc="+TopCatId+"&cc="+CurrentCatId+"&linkid="+linkid+"\">Back</a></td>");
		buf.append("</tr>\n");
		buf.append("</table>\n");
		buf.append("</form>\n");
		return buf;
