...
//import com.ibm.as400.webaccess.common.*;res
public class ETSMetricsCCObj extends ETSMetricsObj {
	...
	public ETSMetricsCCObj(ETSMetricsCCObj obj) {
		super();
		decf = obj.decf;
	...
	void setRatingDate(String d) {
		try {
			...
			this.ratingDate = cal.getTimeInMillis();
		} catch (Exception e) {			
			this.ratingDate = 0;
		}
	}
	...
	public String addAll(double a, double b, double c) {
		double div = 3.0;
		if (a <= 0.0) {
			a = 0.0;
			div = div - 1.0;
		...
		if (all == 0.0 || div == 0.0)
			...
			return String.valueOf(decf.format((a + b + c) / div));
	}
	//	Current Qtr
	public String getOverallCurrRatStr() {
		...
		//			return "";
		//		}
		return addAll(selfCurrRat, setCurrRat, surveyCurrRat);
	}
	...
	public String getOverallPrevRatStr() {
		...
		//			return "";
		//		}
		return addAll(selfPrevRat, setPrevRat, surveyPrevRat);
	}
	...
	public String getOverall2RatStr() {
		...
		//			return "";
		//		}
		return addAll(self2Rat, set2Rat, survey2Rat);
	}
	...
	public String getOverall3RatStr() {
		...
		//			return "";
		//		}
		return addAll(self3Rat, set3Rat, survey3Rat);
	}
	...
	public String getOverall4RatStr() {
		...
		//			return "";
		//		}
		return addAll(self4Rat, set4Rat, survey4Rat);
	}
	...
	public String getOverall5RatStr() {
		...
		//			return "";
		//		}
		return addAll(self5Rat, set5Rat, survey5Rat);
	}
	...
	public String getOverall6RatStr() {
		...
		//			return "";
		//		}
		return addAll(self6Rat, set6Rat, survey6Rat);
	}
	...
	public String getOverall7RatStr() {
		...
		//			return "";
		//		}
		return addAll(self7Rat, set7Rat, survey7Rat);
	}
	...
	public String getOverall8RatStr() {
		...
		//			return "";
		//		}
		return addAll(self8Rat, set8Rat, survey8Rat);
	}
