 ...
 * @author v2srikau
 */
public class DisplayRTFEditorAction extends Action {

	/** Stores the Logging object */
	private static final Log m_pdLog =
		EtsLogger.getLogger(DisplayRTFEditorAction.class);
	...
	public ActionForward execute(
		...
		return pdMapping.findForward(BaseDocumentAction.FWD_SUCCESS);
	}
