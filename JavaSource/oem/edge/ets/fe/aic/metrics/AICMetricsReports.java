...
public class AICMetricsReports {

	public final static String Copyright = "(C)Copyright IBM Corp.  2001 - 2004";
	private static final String CLASS_VERSION = "1.3";


	static public Hashtable getFilterSetting(AICMetricsResultObj o, String s){
		...
		else if (s.equals("CR0001")){
			h.put("crCountry","1");
			h.put("crCompany","1");
			//h.put("crDatasource","1");
			h.put("crFname","1");
			h.put("crLname","1");
			h.put("crEmail","1");
			h.put("date","1");
	...
	static public Vector getColumnsToShowSetting(AICMetricsResultObj o, String s){
		//variable, select name (checkbox),result header,method name, width, name field

		Vector v = new Vector();
		if (s.equals("PR0001")){
			String q[] = AICMetricsDAO.getQuarterAbrString(9);
			...
			String q[] = AICMetricsDAO.getQuarterAbrString(2);
			...
			v.addElement(new String[]{"wsAccessType","Workspace type","Workspace type","WSAccessType","50",""});
			v.addElement(new String[]{"wsname","Workspace name","Workspace name","ProjectName","200",""});
			v.addElement(new String[]{"brand","Brand","Brand","Brand","50",""});
			v.addElement(new String[]{"process","Process","Process","Process","50",""});
			v.addElement(new String[]{"sector","Business Sector","Business Sector","Sector","175",""});
			v.addElement(new String[]{"sceSector","SceSector","SceSector","SceSector","175",""});
			...
			v.addElement(new String[]{"company","Client Company","Client Company","crCompany","50",""});
			v.addElement(new String[]{"job","Job Title","Job Title","crJobTitle","100",""});
			v.addElement(new String[]{"fname","First Name","First Name","crFname","60",""});
			v.addElement(new String[]{"lname","Last Name","Last Name","crLname","60",""});
			v.addElement(new String[]{"email","Email Id","Email Id","crEmail","60",""});
			v.addElement(new String[]{"dphone","Day Phone","Day phone","crDayPhone","100",""});
			v.addElement(new String[]{"fax","Fax","Fax","Fax","100",""});
			v.addElement(new String[]{"evphone","Ev Phone","Evening phone","crEvenPhone","100",""});
			v.addElement(new String[]{"city","City","City","City","60",""});
			v.addElement(new String[]{"country","Country","Country","crCountry","50",""});
			//v.addElement(new String[]{"date","Date","Date","crDate","50",""});
			v.addElement(new String[]{"lasthit","Last logon","Last logon","crLastHit","100",""});
			//v.addElement(new String[]{"datasource","DataSource","DataSource","crDatasource","100",""});
		}
		return v;
	}
