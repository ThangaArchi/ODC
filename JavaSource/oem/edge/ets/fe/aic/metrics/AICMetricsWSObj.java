...
public class AICMetricsWSObj extends AICMetricsObj{
	...
	Timestamp getIssueCreateDateTS(){
		return new Timestamp(issueCreateDate);
	}
	void setIssueCreateDate(java.sql.Timestamp d){
	...
	Timestamp getLastActivityTS(){
		return new Timestamp(lastActivity);
	}
	void setLastActivity(java.sql.Timestamp d){
