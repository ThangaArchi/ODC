 ...
 */
public interface IAICTemplateDAO {
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	
	public ValueObject findByPrimaryKey(ValueObject objValueObject) throws AICDataAccessException;

	public ValueObject findByAllTemplateStatus(ValueObject objValueObject) throws AICDataAccessException;

	public ValueObject insert(ValueObject pValueObject)		throws AICDataAccessException;
	public ValueObject update(ValueObject pValueObject)		throws AICDataAccessException, AICOptimisticLockException;
	...
	public ValueObject findByTemplateName(ValueObject objValueObject) throws AICDataAccessException;
