 ...
 * @author
 */
public class AICTableAction extends BaseDocumentAction {
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.1";
	
	private static Log logger =
					EtsLogger.getLogger(AICTableAction.class);
	...
	public ActionForward executeAction(
		...
		AICTableForm aICTableForm = (AICTableForm) form;
		...
		HttpSession session = request.getSession(true);
				...
				{					
					...
					objAICTableVO.setDocId(Integer.parseInt(aICTableForm.getDoc_id()));					
					objAICTableVO.setTableId(AICUtil.getUniqueId());
					objAICTableVO.setTableName(aICTableForm.getTable_name());
					objAICTableVO.setActive("Y");
					objAICTableVO.setTemplateId(aICTableForm.getTemplate_id());					
					

				AICDynTabTableBusinessDelegate objAICDynTabTableBusinessDelegate = new AICDynTabTableBusinessDelegate();
					objAICTableVO = (AICTableVO) objAICDynTabTableBusinessDelegate.createTableFromTemplate(objAICTableVO);
