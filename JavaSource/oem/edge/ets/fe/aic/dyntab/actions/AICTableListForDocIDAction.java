...
public class AICTableListForDocIDAction extends BaseDocumentAction{
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.4";
	
	private static Log logger =
						EtsLogger.getLogger(AICTableListForDocIDAction.class);
	public ActionForward executeAction(
			...
			throws Exception {
				...
				request = DynTabHelper.setAttributesForDocumentTAB(request,aICTableForm);
				
				
				try
				{	
				String strDocId = (String)request.getParameter("docid");
				...
				ArrayList al = (ArrayList)objAICDynTabTableBusinessDelegate.findByDocID(intDocId);
