 ...
 */
public class AICTemplateEditAction extends Action{
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.1";
		
	private static Log logger =
				EtsLogger.getLogger(AICTemplateEditAction.class);
	public ActionForward execute(
				...
				try {
					...
					//objAICTemplateVO.setTemplateId(objAICTemplateDataForm.getTemplate_name());
					
					objAICTemplateVO =(AICTemplateVO) objAICDynTabTemplateBusinessDelegate.viewTemplate(objAICTemplateVO);
					
					//objAICTemplateVO =(AICTemplateVO) objAICDynTabTemplateBusinessDelegate.viewTemplateByName(objAICTemplateVO);
