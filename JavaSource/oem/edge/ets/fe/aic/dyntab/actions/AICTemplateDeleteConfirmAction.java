 ...
 */
public class AICTemplateDeleteConfirmAction extends Action{
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.3";

	private static Log logger =
					EtsLogger.getLogger(AICTemplateDeleteConfirmAction.class);
		public ActionForward execute(
					...
					String strTemplateId = objAICTemplateDataForm.getTemplate_id();
					String strTemplateName = objAICTemplateDataForm.getTemplate_name();
					...
					request.setAttribute("TemplateName",objAICTemplateVO.getTemplateName());
					request.setAttribute("TemplateId",strTemplateId);
