 ...
 */
public class AICTableShowAction extends BaseDocumentAction{
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.3";
		
	private static Log logger =
			EtsLogger.getLogger(AICTableShowAction.class);
	...
	public ActionForward executeAction(
			...
			AICTableShowForm objAICTableShowForm =
				(AICTableShowForm) form;
			...
			try {
				...
				objAICTableShowForm.setTemplateList(aList);
