 ...
 */
public class AICApplicationException extends Exception {
	public final static String Copyright = "(C)Copyright IBM Corp.  2003 - 2004";
	private static final String CLASS_VERSION = "1.1";
		
	Throwable exceptionCause = null;
	  private String errorCode = "";
	  public AICApplicationException(String pExceptionMsg){
		super(pExceptionMsg);
	  }

	  public AICApplicationException(String pExceptionMsg, Throwable pException){
		super(pExceptionMsg);
	  ...
	  /**
		 ...
		 */
		public AICApplicationException(String errorCode, String message) {
			super(message);
	  ...
	  /**
		 ...
		 */
		public AICApplicationException(String errorCode, String message, Throwable cause) {
			super(message, cause);
			this.errorCode = errorCode;
		}	
