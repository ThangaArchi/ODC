 ...
 * @author
 */
public class ETSUserPhotoServlet extends HttpServlet {
  ...
  public final static String Copyright = "(C) Copyright IBM Corp.  2002, 2003";
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			getPhoto(db.conn,request,response); 
	...
	*/
	...
	private static void getPhoto(Connection con, HttpServletRequest request, HttpServletResponse response) throws SQLException, Exception {
		...
		try {
			...
			sQuery.append("SELECT USER_PHOTO FROM ETS.ETS_USER_INFO WHERE ");
			sQuery.append("USER_ID = ? for READ ONLY");
