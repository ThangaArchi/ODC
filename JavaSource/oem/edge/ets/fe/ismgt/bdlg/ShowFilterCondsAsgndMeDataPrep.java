 ...
 * @author v2phani
 *
 * This bean prepares the data for Filter Conditions when the user clicks Issues assigned to me
 */
public class ShowFilterCondsAsgndMeDataPrep extends FilterDetailsDataPrepAbsBean {

	public static final String VERSION = "1.11";

	/**
	 * Constructor for ShowFilterCondsAsgndMeDataPrep.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ShowFilterCondsAsgndMeDataPrep(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
