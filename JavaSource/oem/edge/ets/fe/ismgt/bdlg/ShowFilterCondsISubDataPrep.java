 ...
 * @author v2phani
 *
 * This bean prepares the data for Filter Conditions when the user clicks Issues I have submitted
 */
public class ShowFilterCondsISubDataPrep extends FilterDetailsDataPrepAbsBean implements EtsIssFilterConstants {

	public static final String VERSION = "1.11";

	/**
	 * Constructor for ShowFilterCondsISubDataPrep.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ShowFilterCondsISubDataPrep(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
