 ...
 * @author v2phani
 *
 * This bean makes all the data reqd, for the  Issues assigned to me report
 */

public class IssuesAsgndMeDataPrepRep extends FilterDetailsDataPrepAbsBean {

	public static final String VERSION = "1.48";

	/**
	 * Constructor for IssuesAsgndMeDataPrepRep.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public IssuesAsgndMeDataPrepRep(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
	...
	public EtsIssFilterDetailsBean getFilterDetails() throws SQLException, Exception {
		...
		if (isDefaultUsrSaveQryExists("ASSGNTOME")) { //if user save does not exists
	...
	public void setDefaultFilterParams() {
		...
		//		getDefStatusTypeList().add("Rejected");
	...
	public void setFilterParams() throws SQLException, Exception {
		...
		if (!isDefaultUsrSaveQryExists("ASSGNTOME")) { //if user save does not exists
			...
			setUserSaveSearchParams("ASSGNTOME");
		}
