 ...
 * @author v2phani
 *
 * This bean prepares the data required,when the user clicks SEARCH button, on Filter Conditions, from Issues I have submitted
 */

public class ShowFilterCondsISubGoDataPrep extends FilterDetailsDataPrepAbsBean {

	public static final String VERSION = "1.11";

	/**
	 * Constructor for ShowFilterCondsISubGoDataPrep.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ShowFilterCondsISubGoDataPrep(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
	...
	public EtsIssFilterDetailsBean getFilterDetails() throws SQLException, Exception {
		...
		if (AmtCommonUtils.getTrimStr(etsFilterBean.getChkSaveQry()).equals("Y")) {
			...
			EtsIssSaveQryModel saveQryModel = deriveSaveQryModel(etsFilterBean, "ISUB");
