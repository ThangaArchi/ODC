...
public class ActionStep_UpdateIssue_Changeowner implements ActionStep {
	public static final String VERSION = "1.0";
	/**
	 * @roseuid 42753BE50021
	 */
	public ActionStep_UpdateIssue_Changeowner() {
	...
	public boolean executeActionStep(
		...
		try {
			if (ComLogGen.generateCommLog(mwIssue) && ETSMW_IssueDAO.changeOwnerofIssueRecord(mwIssue))
						flg=true;
