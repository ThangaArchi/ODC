...
* Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
*/
public class ActionStep_UpdateFeedback_Modify implements ActionStep {
...
oem.edge.ets.fe.ismgt.model.EtsIssObjectKey)
	...
	public boolean executeActionStep(
		...
		EtsIssObjectKey issobjkey) {
			...
			try {
				if (ComLogGen.generateFeedbackCommLog(mwIssue) && ETSMW_IssueDAO.updateActiononFeedbackRecord(mwIssue))
							flg=true;
