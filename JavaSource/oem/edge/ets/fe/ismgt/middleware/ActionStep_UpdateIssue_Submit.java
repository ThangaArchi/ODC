...
public class ActionStep_UpdateIssue_Submit implements ActionStep {
	public static final String VERSION = "1.0";
	/**
	 * @roseuid 42753BE50021
	 */
	public ActionStep_UpdateIssue_Submit() {
	...
	public boolean executeActionStep(
		...
		try {
			if (ComLogGen.generateCommLog(mwIssue) && ETSMW_IssueDAO.insertIssueRecord(mwIssue))
						flg=true;
