 ...
 * of issues I have submitted 
 * 
 */
public class ReportISubIssuesCmd extends FilterCommandAbsBean implements EtsIssFilterConstants {

	public static final String VERSION = "1.10";

	/**
	 * Constructor for ReportISubIssuesCmd.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ReportISubIssuesCmd(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
	...
	public int processRequest() {
		...
		try {
			...
			} else { //if print, get the report tab from session
			...
			AmtCommonUtils.LogSqlExpMsg(se, "SQL Exception in ReportISubIssuesCmd", ETSLSTUSR);
			...
			AmtCommonUtils.LogGenExpMsg(ex, "General Exception in ReportISubIssuesCmd", ETSLSTUSR);
