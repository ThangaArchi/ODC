 ...
 */
public class EtsCSVDownLoadAction extends Action implements EtsIssFilterConstants {

	/**
	 * 
	 */
	public EtsCSVDownLoadAction() {
		super();
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (es.GetProfile(response, request)) {
				...
				FilterDetailsPrepFactoryIF fltrDetIF = new FilterDetailsPrepFactory();

				FilterDetailsDataPrepAbsBean detObj = fltrDetIF.createFilterDetailsPrepBean(request, response, issobjkey);

				ArrayList downLoadList = detObj.getDownLoadList();
				...
				String downLoadCsvName = detObj.getDownLoadFileName();
