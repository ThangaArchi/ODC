 ...
 * @author v2phani
 *
 * This class will process command of clicking srch button on filter cnds,when user clicks Issues I have submitted
 */
public class ShowFilterCondsISubGoCmd extends FilterCommandAbsBean implements EtsIssFilterConstants {

	public static final String VERSION = "1.10";

	/**
	 * Constructor for ShowFilterCondsISubGoCmd.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ShowFilterCondsISubGoCmd(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
