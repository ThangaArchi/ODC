 ...
 */
public class EtsIssFilterWelcomeCmd extends FilterCommandAbsBean {
	 ...
	 * @param issobjkey
	 */
	public EtsIssFilterWelcomeCmd(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
