 ...
 * @author v2phani
 *
 * This class will process command of clicking srch button on filter cnds,when user clicks Issues assigned to me
 */

public class ShowFilterCondsAsgnMeGoCmd extends FilterCommandAbsBean implements EtsIssFilterConstants {

	public static final String VERSION = "1.10";

	/**
	 * Constructor for ShowFilterCondsAsgnMeCmdGo.
	 * @param request
	 * @param response
	 * @param issobjkey
	 */
	public ShowFilterCondsAsgnMeGoCmd(HttpServletRequest request, HttpServletResponse response, EtsIssFilterObjectKey issobjkey) {
